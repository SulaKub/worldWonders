...
//        let wonder = WorldWonder(name: "test", author: "test", year: "test", flag: "test", picture: "test")
...
//        AF.request("https://demo9099789.mockable.io", method: .get).responseDecodable(of: [JSON].self) { response in
...
//        }
//    }
        AF.request("https://demo9099789.mockable.io", method: .get).responseJSON { response in
            SVProgressHUD.dismiss()
